...
This is a candid reviewer-style evaluation for the Bright Data AI Engineer home assignment as of June 18, 2026.
...
| --- | ---: | --- |
| Assignment fit | 10/10 | Meets the repo structure, runnable agent, README, memo, and video-readiness requirements. Agent 2 uses four tools in fast mode and five in deep mode. |
...
| Bright Data MCP usage | 9.5/10 | Meaningfully composes Rapid discovery/scraping plus implemented structured TikTok post and comment tools. |
...
| Engineering quality | 9.5/10 | Clean TypeScript modules, typed shapes, 19 tests, CI, build, clean audit, lockfiles, telemetry, dashboard, and deterministic fallback. |
...
- **Part 2 memo:** Covered by [`../part-2-competitor-memo.md`](../part-2-competitor-memo.md).
